...
- **Comments:** Provide clear and concise comments explaining the _why_ behind code, not just the _what_.
...
- **Test Driven Development:** Unit tests should be written _before_ code implementation.
